...
#define IMPL_ROLE_FROM_THIS(role) \
  const_cast<role&>(static_cast<const role&>(*this))

#define IMPL_ROLE_FROM_THIS_NS(ns, role) \
  const_cast<ns::role&>(static_cast<const ns::role&>(*this))
