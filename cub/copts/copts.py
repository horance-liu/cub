"""Cub compiler options.

This is the source of truth for Cub compiler options.  To modify Cub
compilation options:

  (1) Edit the appropriate list in this file based on the platform the flag is
      needed on.
  (2) Run `<path_to_cub>/copts/generate_copts.py`.
...
COPT_VARS = {
    ...
    "CUB_GCC_EXCEPTIONS_FLAGS": ["-fexceptions"],
    "CUB_LLVM_FLAGS":
        LLVM_BIG_WARNING_FLAGS + LLVM_DISABLE_WARNINGS_FLAGS,
    "CUB_LLVM_TEST_FLAGS":
        LLVM_TEST_DISABLE_WARNINGS_FLAGS,
    "CUB_LLVM_EXCEPTIONS_FLAGS": ["-fexceptions"],
    "CUB_CLANG_CL_FLAGS":
